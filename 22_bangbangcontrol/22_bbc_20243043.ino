...
#define _DUTY_NEU 1490 // 1500
#define _DUTY_MIN 800 // 1000

#define _SERVO_ANGLE_DIFF  120  // Replace with |D - E| degree
#define _SERVO_SPEED       1600  // servo speed

#define _BANGBANG_RANGE    140  // duty up and down for bangbang control
...
float volt_to_distance(int a_value)
{
  ...
  return 703 + (-2.44 * a_value) + 2.11E-03 * a_value * a_value;
}
